...
public class App 
{
	...
	private static final String WINDOW_TITLE = "Tenkaichi LPS Generator v1.7";
	...
	private static void setProgress()
	{
	    ...
	    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>()
		{
			...
			protected Void doInBackground() throws Exception 
			{
				...
				if (msg.equals("")) msg="Automatic Lip-Syncing of "+Main.validWavs+" WAV files applied to "+Main.validPaks+" PAK files in "+time+" s!";
